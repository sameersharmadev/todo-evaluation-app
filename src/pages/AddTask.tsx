...
const AddTask = () => {
  ...
  const [selectedPriority, setSelectedPriority] = useStorageState<Priority | undefined>(
    undefined,
    "priority",
    "sessionStorage",
  );
  ...
  const handleAddTask = () => {
    ...
    const itemsToRemove = ["name", "color", "description", "emoji", "deadline", "categories", "priority"];
