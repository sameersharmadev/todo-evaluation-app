...
import { Category, SortOption, UUID, DateFilter, DateRange } from "../types/user";
...
export const TaskProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [dateFilter, setDateFilter] = useStorageState<DateFilter>("all", "dateFilter", "sessionStorage");
  const [customDateRange, setCustomDateRange] = useStorageState<DateRange>(
    { start: null, end: null },
    "customDateRange",
    "sessionStorage",
  );
